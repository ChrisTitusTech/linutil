...
This command installs SDDM display manager with astronaut theme, configures DWM, sets up the desktop session, and installs related package dependencies.
It also creates the DWM session entry and handles SDDM autologin config cleanup.

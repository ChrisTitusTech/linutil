...
- **Bash Prompt**: The `.bashrc` initializes your interactive shell, setting aliases, functions, history behavior, prompt, and environment variables. This command symlinks and activates the curated configuration from the TL40-Dots repository (an extended, ops-focused fork building on mybash concepts). https://github.com/TuxLux40/TL40-Dots
...
- **Fastfetch**: Fastfetch is a high-performance system info utility (similar to neofetch). This command installs Fastfetch and links the TL40-Dots presets for consistent theming. https://github.com/TuxLux40/TL40-Dots

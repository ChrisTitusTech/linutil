...
echo -e "Installing Cyberpunk GRUB theme..."
...
echo "themes/Cyberpunk/*" | sudo tee -a .git/info/sparse-checkout
sudo git pull origin main
sudo mv themes/Cyberpunk/* .
sudo rm -rf themes
sudo rm -rf .git

echo "Cyberpunk theme has been cloned to ${THEME_DIR}"

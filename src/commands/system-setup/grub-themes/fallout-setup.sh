...
echo -e "Installing fallout GRUB theme..."
...
echo "themes/fallout/*" | sudo tee -a .git/info/sparse-checkout
sudo git pull origin main
sudo mv themes/fallout/* .
sudo rm -rf themes
sudo rm -rf .git

echo "fallout theme has been cloned to ${THEME_DIR}"

#!/bin/bash
# unattended-upgrades full setup for Ubuntu 24.04 / Linux Mint 22.2
# Safe: backups, architecture-aware cleanup, systemd boot config, weekly automated cleanup
...
# ---------------------------
# Clean old APT lists and archives
# ---------------------------
